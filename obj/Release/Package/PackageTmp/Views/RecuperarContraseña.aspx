<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperarContraseña.aspx.cs" Inherits="UTTT.Ejemplo.Persona.Views.RecuperarContraseñaPrincipal" %>
...
<style class="cp-pen-styles">@import url(https://fonts.googleapis.com/css?family=Raleway:400,100,200,300);
    ...
    <body>
                    	...
                    	<div class="justify-content-md-center">
                            ...
                            <p class="login-tab log-in active">&nbsp;</p>
                    	</div>
                        <!-- TABS CONTENT -->
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" id="form1" runat="server">
                                    <asp:TextBox ID="txtCorreoElectronico" runat="server" class="form-control" placeholder="Email" Width="300px"> </asp:TextBox> 
                                    
                                    <br />
                                    <br />
                                    
                        <asp:Button class="btn btn-outline-success" ID="btnAceptar" Width="245px" runat="server" OnClick="btnAceptar_Click" Text="Aceptar"  /> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
