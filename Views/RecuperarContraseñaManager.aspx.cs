...
namespace UTTT.Ejemplo.Persona.Views
{
    public partial class RecuperarContraseñaManager : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (user == null)
            {
                Response.Redirect("~/Views/RecuperarContraseña.aspx", false);
                return;
            }
            else
            {
        ...
        private bool validacion(ref String mensaje)
        {
            ...
            {
                mensaje = "Favor de ingresar una contraseña";
                return false;
            }
            if (this.txtContraseña.Text.Trim().Length > 15)
            {
                mensaje = "La contraseña solo puede tener 15 caracteres máximo.";
                return false;
            }
            if (this.txtContraseña.Text.Trim().Length < 5)
            {
                mensaje = "La contraseña es .";
                return false;
            }
