      ...
      protected void Page_Load(object sender, EventArgs e)
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.lblMensaje.Visible = true;
                    this.lblMensaje.Text = "Verifique su correo para la recuperación de la cuenta";
            ...
            catch (Exception ex)
            {
                ...
                Response.Redirect("~/ErrorFatal.aspx", false);
            }
        }
        ...
        public bool recoveryPasswordEmail(String email, String name, String token)
        {
            try
            {
                ...
                mailMessage.From = new MailAddress("17300174@uttt.edu.mx");
                ...
                smtpClient.Credentials = new NetworkCredential("17300174@uttt.edu.mx", "MAC6421M");
        ...
        {
            String prodUrl = "http://practsd-001-site1.btempurl.com/Views/RecuperarContraseñaManager.aspx?token=" + token;
            String body = "<h2>Hola " + name + "</h2><br>" +
                "<p>¿Restablecer tu contraseña? HAS CLICK EN ESTE LINK" +
                " </p>" +
