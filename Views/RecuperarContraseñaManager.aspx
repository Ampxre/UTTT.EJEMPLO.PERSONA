...
<body>
                    ...
                    <div class="user">
                        <div class="form-wrap">
                            ...
                            <asp:TextBox ID="txtUsuario" runat="server" class="form-control" placeholder="Nombre de Usuario" Width="300px"> </asp:TextBox> 
                                        <br />
                            <asp:TextBox ID="txtContraseña" runat="server" class="form-control" TextMode="Password"  placeholder="Contraseña" Width="300px"> </asp:TextBox>
                                        <br />
                            <asp:TextBox ID="txtRContraseña" runat="server" class="form-control" TextMode="Password" placeholder="Repetir Contraseña" Width="300px"> </asp:TextBox>

                                        <br />

                        <asp:Button class="btn btn-outline-success" ID="btnAceptar" Width="245px" runat="server" OnClick="btnAceptar_Click" Text="Aceptar" OnClientClick="return validaciones(); " /> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:Button class="btn btn-outline-info" ID="btnCancelar" Width="245px" runat="server" OnClick="btnCancelar_Click" Text="Cancelar"/>
                                    </form>
                                </div>
