...
<body class="bg-light">
 ...
 <br />
        ...
        <div class="row form-group"> 
            <asp:Label ID="lblSexo" runat="server" Text="Sexo:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
            &nbsp;
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlSexo" EnableClientScript="False" ErrorMessage="Dato requerido" InitialValue="-1"></asp:RequiredFieldValidator>
              ...
              <%--Estado civil--%>
              <div class="row form-group"> 
            <asp:Label ID="lblEstado" runat="server" Text="Estado civil:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
            <asp:DropDownList ID="ddlEstadoCivil" runat="server" Height="40px" Width="253px" CssClass="form-control col-auto"></asp:DropDownList>
            <asp:RequiredFieldValidator ID="rfvEstadoC" runat="server" ControlToValidate="ddlEstadoCivil" EnableClientScript="False" ErrorMessage="Seleccione su Estado Civil" InitialValue="-1"></asp:RequiredFieldValidator>
                  </div>
               

        <div class="row form-group"> 
            <asp:Label ID="lblClave" runat="server" Text="Clave Unica:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
        ...
        <div class="row form-group">
            ...
            <asp:Label ID="Label1" runat="server" Text="Nombre:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
        ...
        <div class="row form-group"> 
            ...
            <asp:Label ID="Label2" runat="server" Text="A Paterno:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
        ...
        <div class="row form-group">
            <asp:Label ID="Label3" runat="server" Text="A Materno:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
    ...
    <div class="row form-group">   
       <asp:Label ID="Label4" runat="server" Text="Num. Hermanos:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
        ...
        <asp:RegularExpressionValidator ID="RevNHermanos" runat="server" ControlToValidate="txtHermanos" ErrorMessage="Solo se aceptan numeros enteros!!!" ValidationExpression="^\d*$"></asp:RegularExpressionValidator>
             ...
             <div class="row form-group">
                 <asp:Label ID="lblCalendar2" runat="server" Text="Fecha de nacimiento:" class="col-sm-2 col-form-label" Font-Bold="True"></asp:Label>
                 &nbsp;
        ...
        <div class="row form-group"> 
        <asp:Label ID="Label6" runat="server" Text="Correo Electronico:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
        <asp:TextBox ID="txtCorreo" runat="server" Width="246px" CssClass="form-control col-auto" placeholder="Correo Electronico" required='required' pattern="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:TextBox>
         ...
         <div class="row form-group">    
        <asp:Label ID="Label7" runat="server" Text="RFC:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
    ...
    <div class="row form-group">       
        <asp:Label ID="Label8" runat="server" Text="Codigo Postal:" Font-Bold="True" class="col-sm-2 col-form-label"></asp:Label>
